...
class Socket extends React.Component {
  ...
  setupSocket() {
    ...
    socket.on('input:down', Socket.deserialize(({joypadButton, player}) =>
      nes.pressControllerButton(player, joypadButton)));

    socket.on('input:up', Socket.deserialize(({joypadButton, player}) =>
      nes.depressControllerButton(player, joypadButton)));

    socket.on('info:update', Socket.deserialize(this.props.onQueueUpdate));
